...
def options(rounds):
    ...
    while running:
        draw_bg()
        draw_text('LIKE ZOINKS SCOOB, THIS IS ONE OF THOSE OPTION SELECT THINGIES!',
                  font, (0, 255, 0), screen, 20, 20)
        mx, my = pygame.mouse.get_pos()

        if (rounds != -1):
            draw_text('I SHALL MAKE QUICK WORK OF YOU...',
                      font, (255, 0, 0), screen, 20, 60)
        else:
            draw_text('IF AN ETERNAL SUFFERING IS WHAT YOU DESIRE, THEN SO BE IT...',
                      font, (255, 0, 0), screen, 20, 60)
